...
echo "3/6 验证 PostgreSQL 与 Redis 连接"
compose exec -T postgres sh -ec \
...
echo "4/6 写入持久化探针并验证 MinIO 测试对象"
probe_written=true
compose exec -T postgres sh -ec \
