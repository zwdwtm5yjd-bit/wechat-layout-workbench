...
本包内置十套发布状态的不可变 `1.0.0` 主题：

- `高级极简`：默认通用长文主题，强调留白、字阶和细线；
- `现代政务红`：面向政务、巡察和国企内容的深红米金主题；
- `科技蓝金`、`校园青春`、`夏日森系`、`旅行杂志`、`食味暖橙`、`人物专访`、`节日红金`和 `国风雅韵`：
  覆盖主要行业、用途、节假、风格和色调的场景主题。

主题分类额外吸收了公众号 H5 素材中高频且可复用的内容场景，包括放假通知、温馨提示、安全
提醒、活动纪实、主题教育、党建宣传、党日活动、会议报道、节气科普、节气食育和节日祝福；
节假维度覆盖二十四节气、春节、元旦、除夕、小年、清明、劳动节、母亲节、端午、中秋、国庆、
重阳和腊八。分类只复用内容语义，不复制来源图片、外部模板代码或版权资产。
