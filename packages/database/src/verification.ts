...
const expectedTables = [
  ...
  "content.articles",
  "content.copy_records",
  "content.render_outputs",
  "content.resources",
...
const expectedIndexes = [
  ...
  "idx_copy_records_actor_copied",
  "idx_copy_records_article_copied",
  "idx_copy_records_output",
...
const expectedForeignKeyDeleteActions = new Map<string, "CASCADE" | "RESTRICT">([
  ...
  ["copy_records_article_id_articles_id_fk", "RESTRICT"],
  ...
  ["render_outputs_article_id_articles_id_fk", "RESTRICT"],
  ["render_outputs_generated_by_users_id_fk", "RESTRICT"],
  ["render_outputs_snapshot_id_article_snapshots_id_fk", "RESTRICT"],
